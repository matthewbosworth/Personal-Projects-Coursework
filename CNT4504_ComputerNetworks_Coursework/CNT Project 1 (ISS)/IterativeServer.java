...
public class IterativeServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Iterative server listening on port " + port);

        while (true) {
            // Blocks until a client connects — only one at a time (iterative)
            ...
            // Loops back to accept() — next client only served after this one finishes
        }
    }
}